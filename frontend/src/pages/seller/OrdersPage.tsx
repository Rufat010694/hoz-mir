  ...
  return (
    <div className="flex-1 overflow-auto p-4 md:p-6 pb-20 md:pb-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button size="sm" onClick={() => setShowCreate(true)}>+ Создать заказ</Button>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 text-gray-500 text-xs uppercase">
            <tr>
              ...
              <th className="px-4 py-3 text-left hidden md:table-cell">Оплата</th>
              <th className="px-4 py-3 text-right hidden md:table-cell">Время</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50">
            {isLoading ? (
              ...
              >
                ...
                <td className="px-4 py-3 hidden md:table-cell"><PaymentBadge method={o.payment_method} /></td>
                <td className="px-4 py-3 text-right text-gray-500 hidden md:table-cell">{formatDate(o.created_at)}</td>
              </tr>
            ))}
          </tbody>
        </table>
